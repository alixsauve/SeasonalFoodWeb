...
% For all of these simulations, the predator density-dependent mortality rates are based on estimates of predator intrinsic growth rates (DD = DDData).
...
dlmwrite(char(strcat('../Outputs/TS_', DDName, '_SmI.csv')), [TI YI], 'delimiter', ',');
clear TI YI
...
dlmwrite(char(strcat('../Outputs/TS_', DDName, '_SmII.csv')), [TII YII], 'delimiter', ',');
clear TII YII
